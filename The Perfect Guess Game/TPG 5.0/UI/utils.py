...
class Button : 
   ...
   def __init__(self, img1, img2, img3, posn_percentage, screen, screen_width, screen_height, audio="keyboard_click.wav") : 
   ...
   def draw(self) : 
      ...
      if self.rect.collidepoint(mx, my) : 
         if pygame.mouse.get_pressed()[0] : #Mouse clicks --> for press = 0, 1, 2.... for event = 1, 2, 3... (leftclick, middle, rightclick)
            ...
            if self.clicked : 
               keyboard_click = pygame.mixer.Sound(os.path.join(sound_effect_path, self.audio))
...
class Syringe : 
   ...
   def __init__(self, img1, img2, img3, posn_percentage, screen, screen_width, screen_height, audio="truth_serum_click.wav") : 
      self.img1 = pygame.image.load(os.path.join(TPG_path, "UI", "ui", "truth_serum", img1)).convert_alpha()
      self.img2 = pygame.image.load(os.path.join(TPG_path, "UI", "ui", "truth_serum", img2)).convert_alpha()
      self.img3= pygame.image.load(os.path.join(TPG_path, "UI", "ui", "truth_serum", img3)).convert_alpha()
